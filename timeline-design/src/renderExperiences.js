  ...
  fetch('../experiences.json')
    ...
    .then((data) => {
      ...
      data.forEach((experience) => {
        ...
        templateClone.querySelector('.tmline-item__img').src = experience.company.logo;
        templateClone.querySelector('.tmline-item__img').alt = experience.company.alt;
        ...
        templateClone.querySelector('.tmline-item__job-description').textContent =
